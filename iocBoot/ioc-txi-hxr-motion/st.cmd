...
epicsEnvSet("ADS_MAX_PARAMS",   "4225")
...
epicsEnvSet("PREFIX",         "PLC:TXI:HXR:MOT:")
epicsEnvSet("NUMAXES",        "53")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:TXI:HXR:MOT")
dbLoadRecords("save_restoreStatus.db", "P=PLC:TXI:HXR:MOT:")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:TXI:HXR:MOT,PROJECT=plc-txi-hxr-motion.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.14.1+0.g20d35b3.dirty,PLC_HOST=172.21.136.31")

#   LCLS General: * -> 2.8.1 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:HXR:MOT,DEPENDENCY=LCLS_General,VERSION=2.8.1,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 1.5.1 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:HXR:MOT,DEPENDENCY=lcls-twincat-motion,VERSION=1.5.1,VENDOR=SLAC")
#   lcls-twincat-physics: * -> 0.0.0 (SLAC)
